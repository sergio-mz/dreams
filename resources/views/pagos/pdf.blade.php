    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="card mb-1 p-2 pl-4">
                <h5 class="card-title"><strong>Referencia de Pago</strong></h5>
            ...
            <div class="card mb-1 p-2 pl-4">
                <h5 class="card-title"><strong>Valor Total Reserva</strong></h5>
                <p class="card-text">$ {{ number_format($pago->booking->total, 0, ',', '.') }}</p>
            </div>
            ...
            <div class="card mb-1 p-2 pl-4">
                <h5 class="card-title"><strong>Pago Realizado</strong></h5>
