                            ...
                            <tr class="bg-white border">
                                <td class="align-middle">
                                    <ul class="list-unstyled mb-1 pl-2">
                                        <li><strong><a
                                                    href="{{ route('reservas.show', $reserva) }}">{{ $reserva->id }}</a></strong>
                                        </li>
                                    </ul>
                                </td>
                                <td class="align-middle">
                                    <ul class="list-unstyled mb-1 pl-2">
                                        <li><strong><a
                                                    href="{{ route('reservas.show', $reserva) }}">{{ $reserva->customer->document }}</a></strong>
                                        </li>
                                    </ul>
                                </td>
                                <td class="align-middle">
                                    <ul class="list-unstyled mb-1 pl-2">
                                        <li><strong><a
                                                    href="{{ route('reservas.show', $reserva) }}">{{ $reserva->start_date }}</a></strong>
                                        </li>
                                    </ul>
                                </td>
                                <td class="align-middle">
